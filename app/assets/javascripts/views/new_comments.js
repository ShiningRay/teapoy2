    ...
    for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      _results.push(li("." + (comment.class_names.join(' ')), {
        ...
        div(".name", function() {
          ...
          return sup(".floor", "" + comment.floor);
        });
        if (comment.parent_id !== 0) {
          a("in-reply-to", {
            href: "#floor-" + comment.parent_id
          }, "&nbsp;→" + comment.parent_id + "L");
        }

...
article(".cf.hentry.article", {
  ...
  div(".user-info", function() {
    if (this.article.anonymous) {
      div(".user-avatar", function() {
        return span(function() {
          return img(".avatar", {
            src: this.top_post.user.avatar_url.replace("thumb", "small"),
            alt: "" + this.top_post.user.name
          });
        });
      });
      return div(".user-name", function() {
        return span("" + this.top_post.user.name);
      });
    } else {
      div(".user-avatar", function() {
        return a({
          href: "/users" + this.article.user.login
        }, function() {
          return img(".avatar", {
            src: this.article.user.avatar_url.replace("thumb", "small"),
  ...
  return div("." + (this.top_post.class_names.join(' ')), {
    ...
    div(".user-and-group", function() {
      div(".group-name", function() {
        text(" 发布于 ");
        return a(".group", {
      ...
      return div(".post-signature", function() {
        time(".relativetime", {
          title: "" + this.article.time_ago_in_words,
          datetime: "" + this.article.time_ago_in_words
        }, "" + this.article.time_ago_in_words);
        div(".markread", function() {
          return a({
            href: "#",
            title: "标记为已读"
          });
        });
        return ul(".suckerfish", function() {
          return li("", function() {
            a(".show-article-actions", "");
            return ul(".article-actions", function() {
              li(function() {
                return a(".show-article-actions", {
                  href: "#",
              ...
              if (window.B.isLoggedIn() && current_user.login === this.top_post.user.login) {
                li(".admin", function() {
                  return a({
                    rel: "nofollow",
                    "data-remote": "true",
                    "data-method": "delete",
                    "data-confirm": "确定要删除这篇帖子吗?",
                    href: "/" + this.article.group + "/" + this.article.id
                  }, "删除");
                });
                return li(".admin", function() {
                  return a({
                    href: "/" + this.article.group + "/" + this.article.id + "/edit"
                  }, "修改");
                });
              }
            });
    ...
    return ul('.meta.cf', function() {
      ...
      return li('.comment-status', function() {
        return a("comments", {

...
module Html5BoilerplateHelper
  ...
  def ie_tag(name=:body, attrs={}, &block)
    ...
    haml_concat("<!--[if lt IE 7]> #{ tag(name, add_class('ie6 lt-ie9 lt-ie8 lt-ie7', attrs), true) } <![endif]-->".html_safe)
    haml_concat("<!--[if IE 7]>    #{ tag(name, add_class('ie7 lt-ie9 lt-ie8', attrs), true) } <![endif]-->".html_safe)
    haml_concat("<!--[if IE 8]>    #{ tag(name, add_class('ie8 lt-ie9', attrs), true) } <![endif]-->".html_safe)

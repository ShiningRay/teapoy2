(function(){ 
  ...
  this.templates["groupcard"] = function anonymous(data) {
var a,article,b,div,i,li,p,q,rt,s,script,small,th,u,br,hr,img;a = function(){return __ck.tag('a', arguments);};article = function(){return __ck.tag('article', arguments);};b = function(){return __ck.tag('b', arguments);};div = function(){return __ck.tag('div', arguments);};i = function(){return __ck.tag('i', arguments);};li = function(){return __ck.tag('li', arguments);};p = function(){return __ck.tag('p', arguments);};q = function(){return __ck.tag('q', arguments);};rt = function(){return __ck.tag('rt', arguments);};s = function(){return __ck.tag('s', arguments);};script = function(){return __ck.tag('script', arguments);};small = function(){return __ck.tag('small', arguments);};th = function(){return __ck.tag('th', arguments);};u = function(){return __ck.tag('u', arguments);};br = function(){return __ck.tag('br', arguments);};hr = function(){return __ck.tag('hr', arguments);};img = function(){return __ck.tag('img', arguments);};var __slice = Array.prototype.slice;var __hasProp = Object.prototype.hasOwnProperty;var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };var __extends = function(child, parent) {  for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }  function ctor() { this.constructor = child; }  ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype;  return child; };var __indexOf = Array.prototype.indexOf || function(item) {  for (var i = 0, l = this.length; i < l; i++) {    if (this[i] === item) return i;  } return -1; };
...
div(".groupcard.hovercard", {
  id: "groupcard-" + this.alias
}, function() {
  div(".icon", function() {
    return a({
      href: this.group_url
  ...
  div(".detail", function() {
    div(".name", this.name);
    br;
    return div(".description", this.description);
  });
  return div(".join", function() {
    a(".join_group", {
      href: this.join_or_quit_group_url
    }, this.join_or_quit_text);
    text(" | ");
    return a({
      href: this.new_article_path,
      target: "_blank"
    }, "发表");
  });
});

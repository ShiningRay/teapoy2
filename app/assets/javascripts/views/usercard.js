...
div(".usercard.hovercard", {
  id: "usercard-" + this.login
}, function() {
  div(".icon", function() {
    return a(".icon", {
      href: this.group_url
  ...
  return div(".detail", function() {
    ...
    return div(".join", function() {
      a(".follow", {
        href: this.follow_or_unfollow_url
      }, this.follow_or_unfollow_text);
      text(" | ");
      return a(".send-message", {
        href: this.message_url
      }, "小纸条");
    });
  });
});

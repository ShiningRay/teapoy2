(function(){ 
  ...
  this.templates["notifications"] = function anonymous(data) {
var a,article,b,div,i,li,p,rt,s,span,sub,th,u,ul,hr;a = function(){return __ck.tag('a', arguments);};article = function(){return __ck.tag('article', arguments);};b = function(){return __ck.tag('b', arguments);};div = function(){return __ck.tag('div', arguments);};i = function(){return __ck.tag('i', arguments);};li = function(){return __ck.tag('li', arguments);};p = function(){return __ck.tag('p', arguments);};rt = function(){return __ck.tag('rt', arguments);};s = function(){return __ck.tag('s', arguments);};span = function(){return __ck.tag('span', arguments);};sub = function(){return __ck.tag('sub', arguments);};th = function(){return __ck.tag('th', arguments);};u = function(){return __ck.tag('u', arguments);};ul = function(){return __ck.tag('ul', arguments);};hr = function(){return __ck.tag('hr', arguments);};var __slice = Array.prototype.slice;var __hasProp = Object.prototype.hasOwnProperty;var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };var __extends = function(child, parent) {  for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }  function ctor() { this.constructor = child; }  ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype;  return child; };var __indexOf = Array.prototype.indexOf || function(item) {  for (var i = 0, l = this.length; i < l; i++) {    if (this[i] === item) return i;  } return -1; };
...
if (data.length > 0) {
  ...
  ul({
    ...
    for (_i = 0, _len = data.length; _i < _len; _i++) {
      notification = data[_i];
      if (notification.subject_type === "Article" && notification.article_name) {
        _results.push(li(".notification", {
          id: "" + notification._id,
          data: {
            "group_alias": "" + notification.group_alias,
            "article_id": "" + notification.subject_id,
            "comment_id": "notification.subject_id",
            "article_url": "/" + notification.group_alias + "/" + notification.subject_id
          }
        }, function() {
          var actor, _j, _len2, _ref;
          _ref = notification.actors;
          for (_j = 0, _len2 = _ref.length; _j < _len2; _j++) {
            actor = _ref[_j];
            a({
              href: "/users/" + actor.login
            }, "" + actor.name);
          }
          text("在主题");
          a({
            href: "/" + notification.group_alias + "/" + notification.subject_id
          }, "" + notification.article_name);
          if (notification.scope === "mention") {
            return text("中提到了你");
          } else {
            return text("中回复了你");
          }
        ...
        _results.push(li(".notification", {
          ...
          text("邀请你加入小组");
          a({
            href: "/groups/" + notification.group_alias
          }, "" + notification.group_name);
          text("&nbsp;&nbsp;&nbsp;");
          return a(".join_group", {
            href: "/groups/" + notification.group_alias + "/join"
          }, "接受");
        }));
      }
    }

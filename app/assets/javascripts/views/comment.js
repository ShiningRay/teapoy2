(function(){ 
  ...
  this.templates["comment"] = function anonymous(data) {
var a,article,b,body,del,div,em,html,i,li,ol,p,rt,s,script,span,style,sup,th,tr,u,col,hr,img;a = function(){return __ck.tag('a', arguments);};article = function(){return __ck.tag('article', arguments);};b = function(){return __ck.tag('b', arguments);};body = function(){return __ck.tag('body', arguments);};del = function(){return __ck.tag('del', arguments);};div = function(){return __ck.tag('div', arguments);};em = function(){return __ck.tag('em', arguments);};html = function(){return __ck.tag('html', arguments);};i = function(){return __ck.tag('i', arguments);};li = function(){return __ck.tag('li', arguments);};ol = function(){return __ck.tag('ol', arguments);};p = function(){return __ck.tag('p', arguments);};rt = function(){return __ck.tag('rt', arguments);};s = function(){return __ck.tag('s', arguments);};script = function(){return __ck.tag('script', arguments);};span = function(){return __ck.tag('span', arguments);};style = function(){return __ck.tag('style', arguments);};sup = function(){return __ck.tag('sup', arguments);};th = function(){return __ck.tag('th', arguments);};tr = function(){return __ck.tag('tr', arguments);};u = function(){return __ck.tag('u', arguments);};col = function(){return __ck.tag('col', arguments);};hr = function(){return __ck.tag('hr', arguments);};img = function(){return __ck.tag('img', arguments);};var __slice = Array.prototype.slice;var __hasProp = Object.prototype.hasOwnProperty;var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };var __extends = function(child, parent) {  for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }  function ctor() { this.constructor = child; }  ctor.prototype = parent.prototype; child.prototype = new ctor; child.__super__ = parent.prototype;  return child; };var __indexOf = Array.prototype.indexOf || function(item) {  for (var i = 0, l = this.length; i < l; i++) {    if (this[i] === item) return i;  } return -1; };
...
li("." + (data.class_names.join(' ')), {
  ...
  div(".midcol." + data.rate_status, function() {
    div(".arrow.up", "");
  ...
  sup(".floor", "" + data.floor);
  sup(".date", "" + data.created_at);
  div(".body", "" + data.html);
  return div(".operator", {
    style: "text-align:right;"
  }, function() {
    a(".reply", {
      href: "javascript:replyComment(" + data.id + "," + data.article_id + ",data.floor)",

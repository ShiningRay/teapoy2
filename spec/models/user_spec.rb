...
describe User do
  ...
  it 'does not require login' do
    lambda do
      ...
      @user.errors[:login].should be_empty
    end.should change(User, :count)
    @user.state.should == 'passive'
  end

  describe 'not allow these logins:' do
  ...
  describe 'disallows illegitimate logins:' do
    ['12', '1234567890_234567890_234567890_234567890_', "\u{200c}test", "\u{200e}test", "tab\t", "newline\n",
